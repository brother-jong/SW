...
print("text3에 인덱스 5부터 10까지 중에서 'i'가 몇개 있나요?", text3.count('i', 5, 10))
print("text3에 인덱스 5이후에 'o'가 몇개 있나요?", text3.count('o', 5))
...
print("text3가 'i loke'로 시작하는가? ", text3.startswith('i like'))
...
# print("list1 내용에 '-'기호를 결합: ", '-'.join(list2))
